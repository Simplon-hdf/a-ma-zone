...
-- AddForeignKey
ALTER TABLE "Belong" ADD CONSTRAINT "Belong_order_number_fkey" FOREIGN KEY ("order_number") REFERENCES "Orders"("order_number") ON DELETE RESTRICT ON UPDATE CASCADE;
